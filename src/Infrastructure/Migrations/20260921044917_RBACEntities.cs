        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackendUrl = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    FrontendUrl = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POSRoles", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAccesses_POSUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPOSRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPOSRoles_POSUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "POSUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
