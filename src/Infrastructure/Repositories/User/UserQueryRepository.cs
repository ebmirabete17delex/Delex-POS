...
public class UserQueryRepository : QueryHandlerBase<Domain.Entities.RBAC.User>, IUserQueryRepository
{
    public UserQueryRepository(ApplicationDbContext dbContext) : base(dbContext) { }

    // public async Task<Domain.Entities.RBAC.User?> GetUserByNameAsync(string name)
    // {
