...
public class UserRoleQueryRepository : QueryHandlerBase<Domain.Entities.RBAC.UserRole>, IUserRoleQueryRepository
{
    public UserRoleQueryRepository(ApplicationDbContext dbContext) : base(dbContext) { }
