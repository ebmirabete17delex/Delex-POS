...
public class RoleQueryRepository : QueryHandlerBase<Domain.Entities.RBAC.Role>, IRoleQueryRepository
{
    public RoleQueryRepository(ApplicationDbContext dbContext) : base(dbContext) { }
